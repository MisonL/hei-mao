...
function Set-PetConfiguration {
    ...
    switch ($requestedPetId) {
        "hei-mao" {
            ...
            $script:SpritesheetSha256 = "52dae8bb17ecf40d2b31cb80a1afbfa366bdfa3949c328faaf58717e0d66c07c"
        ...
        "hei-mao-quality" {
            ...
            $script:SpritesheetSha256 = "3a117af73f978216cff925c55abc97aa3f41cd79635efab3cf77a78e445f8696"
            $script:PetSubdir = "pets/$requestedPetId"
        }
        "hei-mao-butler" {
        ...
        "hei-mao-foodie" {
            ...
            $script:SpritesheetSha256 = "eba3849e27fdebb6f1df4f5cacc39328f2b6c7e97f5e11fb15b3ebff11b2d3b0"
            $script:PetSubdir = "pets/$requestedPetId"
        }
        "hei-mao-delivery" {
            $script:PetJsonSha256 = "16e5e9aaf0033e4676b7a298f55562607382a1a1d1fbe7ecf4377ffcd86c46a2"
            $script:SpritesheetSha256 = "6b3ceef6f74aa92d503eed294ee04b7dd65c53504ce31aa5a8e30c0ff252fe86"
            $script:PetSubdir = "pets/$requestedPetId"
        }
        "hei-mao-fortune" {
        ...
        "hei-mao-traveler" {
            ...
            $script:SpritesheetSha256 = "d1f13ed88ff625f9698ca58f45d0870b017c55b7c052f1736b31b67c6a002b25"
            $script:PetSubdir = "pets/$requestedPetId"
        }
        default {
