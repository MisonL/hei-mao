...
- `qa/remote-main-sync-recheck-20260820-v3.json`: 2026-08-20T07:11:06Z 绑定提交 `471bbf7` 的最终本地、GitHub 和 GitLab `main` 一致性、GitHub raw README 可达性和工作树边界复核；保留用户原有未跟踪目录，不含本机环境信息
