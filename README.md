...
- `qa/current-state-recheck-20260814-v25.json`: 基于提交 `e843623` 的当前八角色发布门禁、PetDex 公开资源、上游 issue/PR 状态、CLI/Hook 边界、Desktop 动画/角色切换/多屏气泡、三处目录 parity、远端一致性和 Codex App 视觉验收边界，不含本机环境信息
...
- `qa/petdex-public-resource-recheck-20260814-v3.json`: 当前公开 manifest、六个公开角色实际下载资源的 SHA/尺寸和 metadata 字节/语义对照；纠正 quality metadata 字节匹配结论
