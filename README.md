...
- `qa/petdex-public-resource-recheck-20260814-v4.json`: 当前提交下实时公开 manifest、六个公开角色实际下载资源的 SHA/尺寸和 metadata 字节/语义对照
